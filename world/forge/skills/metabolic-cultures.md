<!--
Forge writer snapshot of the metabolic-cultures skill (inlined into writer prompts; SHA-256 pinned in freeze.json.skills).
Upstream: https://github.com/jwynia/agent-skills/tree/e02ec7e226a6e4f8419fd3b88a1d8e472d421b32/skills/creative/fiction/worldbuilding/metabolic-cultures
...
For an existing project, read its current life-support design, canon, candidate status, and writing conventions first. The culture types, metabolic kinship, and multi-generational examples below are creative options, not automatic facts about a ship or its first crew. Respect a read-only request; write only when the task calls for a durable artifact. Follow the project's established directories and ask for an output location only when it cannot be inferred.
...
3. Do not create a new output configuration or directory solely to use this skill. For a read-only review, report findings in conversation.
